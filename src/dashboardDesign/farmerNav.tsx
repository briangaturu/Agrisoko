import { SquareUserRound, LogOut, Wheat, List, MessageCircle, Bell, Home, ShoppingBag, LayoutDashboard } from "lucide-react";
...
export const FarmerTopNav = ({ onLogout }: FarmerTopNavProps) => {
  const location = useLocation();

  const NAV_ITEMS = [
    { to: "/farmer-dashboard", label: "Statistics",    icon: LayoutDashboard },
