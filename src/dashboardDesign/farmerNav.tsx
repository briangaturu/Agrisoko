import { SquareUserRound, LogOut, Wheat, LayoutDashboard, List } from "lucide-react";
    ...
    <ul className="menu bg-green-600 text-white shadow-lg min-w-full gap-2 min-h-full p-3">
      ...
      <li className="mt-auto">
        <button
          ...
          className="w-full flex items-center gap-3 rounded-md px-3 py-2 text-red-200 hover:bg-red-600 hover:text-white transition"
        >
          <LogOut />
          Logout
        </button>
